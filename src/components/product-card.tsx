        ...
        <DialogContent className={`${styles.flexStart} flex-col p-0 border-0 `}>
          ...
          >
            ...
            >
              <div className={`flex justify-start items-center gap-2`}>
                <VariantIcon size={20} />
                <h3 className={` ${styles.Xsmall} font-semibold`}>Variants</h3>
              </div>
              <RadioGroup
                className="grid grid-cols-3 w-full gap-2"
            ...
            <div className={`${styles.flexStart} flex-col gap-4 w-full`}>
              <div className={`flex justify-start items-center gap-2 pb-1`}>
                ...
                <h3 className={` ${styles.Xsmall} font-semibold`}>Add-ons</h3>
              </div>

              {product.addOns.map((addOn, addOnIndex) => (
                <div className={`grid place-items-center gap-1 px-2 w-full`}>
                  <div
                    key={addOnIndex}
            ...
            <form>
              ...
              >
                <SquarePen className="h-4 w-4 " /> Note
              </Label>
              <Input
                value={product.note}
                id="search"
          ...
          <div
            className={`grid grid-row-2 w-full gap-2 p-3 border border-muted-foreground/30  `}
          >
            <div
              className={`grid grid-cols-[1fr_auto] w-full gap-3 p-1 border border-muted-foreground/50 rounded-t-lg`}
            >
              <div
            ...
            <div className={`grid grid-cols-2 w-full gap-2 `}>
              <DialogTrigger>
                <Button variant={"outline"} className="w-full rounded-t-none">
                  Back
                </Button>
              </DialogTrigger>
